...
def generate_launch_description():
    ...
    world = os.path.join(
        get_package_share_directory('project1phase1'),
        'worlds',
    ...
    pkg_gazebo = get_package_share_directory('project1phase1')
...
#     # Get the package directory 
#     pkg_robotaxi_gazebo = get_package_share_directory('project1phase1')
